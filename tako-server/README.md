...
- Serve signed optimized AVIF/WebP image URLs under `/_tako/image/v1/...` with typed height/fit/crop thumbnails, 7-day private-by-default browser caching, private signed browser cache overrides, and explicit public immutable caching.
