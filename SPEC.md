...
- Proxy request debug logs include response compression fields for algorithm, skip reason, whether `Vary` was required, and uncompressed/compressed byte counts when available.
