...
fn parse_event_line_parses_tunnel_mode_changed_event() {
    let line = r#"{"type":"Event","event":{"type":"TunnelModeChanged","config_path":"/proj/tako.toml","app_name":"app","enabled":true,"url":"https://a8f3k2zz.tako.website","expires_at":1778220000}}"#;
    assert_eq!(
        parse_event_line(line),
...
fn parse_event_line_parses_tunnel_connection_changed_event() {
    ...
    assert_eq!(
        parse_event_line(line),
        Some(DevServerEvent::TunnelConnectionChanged {
            config_path: "/proj/tako.toml".to_string(),
            app_name: "app".to_string(),
            connected: false,
