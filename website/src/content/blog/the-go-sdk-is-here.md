...
Go's approach to [secrets](/blog/secrets-without-env-files) leans into the type system. Run `tako gen` and it generates a `tako_secrets.go` file with a typed struct:

```go
// Generated by tako gen — DO NOT EDIT.
var Secrets = struct {
