...
| `tako.toml`    | App choice of runtime and preset, explicit overrides, routes, vars, build stages, storage, encrypted backups, SSL provider, source-IP mode, and deploy targets.                  |
